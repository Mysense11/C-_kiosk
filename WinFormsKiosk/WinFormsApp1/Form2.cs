...
namespace WinFormsApp1
{
    public partial class Form2 : Form
    {
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("더 이상 취소할 메뉴가 없습니다.");
            }
        ...
        private void btnPay_Click(object sender, EventArgs e)
        {
            ...
            string str = cbPay.Text + "(으)로" + listbPay.Text + "결제방법을" + "\n선택하셨습니다.";
            MessageBox.Show(str);
        }
        //메뉴 계산서 띄우기 이벤트
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            a.Text = "탕수육";
            a.Location = new System.Drawing.Point(700, 52 + y);
            b.Location = new System.Drawing.Point(850, 52 + y);
            //각 객체의 위치조정
            y += 30;
